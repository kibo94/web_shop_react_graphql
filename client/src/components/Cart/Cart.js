...
import mutation from "../../mutations/addToHistory"
// import mutation2 from "../../mutations/addOrderToOrders"
...
const Cart = ({ mutate }) => {
  const {setUser ,emptyCart , setOrders,orderss} = useContext(DataContext)
...
//  setUser({...user,history:[...user.history,...cart]})
        emptyCart()
    }
